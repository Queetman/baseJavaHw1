...
> Правка к видео: ArrayStorage.delete() - вместо `ru.basejava.ru.exception.storage[i] = null` нужно `ru.basejava.ru.exception.storage[size-1] = null`
...
- Сделать проверки: в `update/delete/get` - резюме есть в ru.basejava.ru.exception.storage, в `save`- нет в ru.basejava.ru.exception.storage: `System.out.println("Resume ...")`.
